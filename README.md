...
> **⚠️ Status Note:** This repository is currently being refactored from a local development environment for public open-source release. The full source code, including the C++ execution module, is scheduled to be pushed by **February 17th, 2026**.
